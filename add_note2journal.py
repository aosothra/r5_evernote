...
if __name__ == '__main__':
    ...
    en_journal_guid = os.getenv('JOURNAL_NOTEBOOK_GUID')
    en_template_guid = os.getenv('JOURNAL_TEMPLATE_NOTE_GUID')
    ...
    new_note = noteStore.copyNote(en_template_guid, en_journal_guid)
